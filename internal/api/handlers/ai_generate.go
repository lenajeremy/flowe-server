...
func nodeCatalog() []map[string]any {
	return []map[string]any{
		...
		},
		{
			...
			"description": "Runs a bounded Codex task in an isolated Daytona workspace against a GitHub repository. The user must connect Codex in the node sidebar, and private repositories also require their GitHub connection.",
			"dataFields": map[string]any{
				"codingAgentRuntime":           "string – currently 'codex'",
				"codingAgentTask":              "string – concrete coding task; supports {{nodeId.output}} templates",
				"codingAgentRepository":        "string – GitHub owner/repository, without a URL",
				...
				"codingAgentAllowedDomains":    "string[] – extra domain names the task may reach; runtime, npm, and GitHub domains are always included",
