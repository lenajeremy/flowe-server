...
type Workflow struct {
	...
	// Published gates unattended schedule and integration-event runs. Manual
	// runs, direct webhooks, and API-key triggers always work, published or not.
...
// ScheduledTrigger runs a workflow on a calendar-based or fixed-interval schedule.
